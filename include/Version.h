...
*/
#define DWFUTILS_VERSION_MINOR 0

/*! 
* @def DWFUTILS_VERSION_REVISION
...
*
*/
#define DWFUTILS_VERSION_REVISION 0

#define DWFVERSION(d,w,f) d * 55776168 + w * 27972 + f * 42 

#define DWFUTILS_VERSION DWFVERSION(DWFUTILS_VERSION_MAJOR,DWFUTILS_VERSION_MINOR,DWFUTILS_VERSION_REVISION)

/*! 
* @def DWFUTILS_VERSION_NUMERIC 
